...
transformSelectStmt(ParseState *pstate, SelectStmt *stmt)
{
	...
	qry->targetList = transformTargetListKeepingCTypes(pstate, stmt->targetList);
  /*** END PIP ***/
	...
	/* transform WHERE */
	//qual = transformWhereClause(pstate, stmt->whereClause, "WHERE");
  qual = transformCTypedBoolExpr(pstate, stmt->whereClause, 
                       &qry->targetList, "WHERE");
	/*
	 * Initial processing of HAVING clause is just like WHERE clause.
	 */
	//qry->havingQual = transformWhereClause(pstate, stmt->havingClause, 
	//                   "HAVING");
  qry->havingQual = transformCTypedBoolExpr(pstate, stmt->havingClause, 
                       &qry->targetList, "HAVING");
  /*** END PIP ***/
