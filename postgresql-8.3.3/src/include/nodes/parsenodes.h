...
typedef struct SelectStmt
{
	...
	/* MAYBMS BEGIN */
	bool		possible;		/* presence of POSSIBLE construct */		
	List	   *repairkey;		/* key to be repaired */		
	ResTarget  *weightby;		/* the weight of a tuple */
	char 		tabletype;		/* the type of the result of the select */
	int4 		dimension;		/* the number of triples of condition columns */
	bool	   *isFromRepairKey;       /* whether the triple comes from repair-key */	
	char		pickingType;	/* the type of picking tuples
								 * Currently, it can only be 'I'.
								 */
	ResTarget  *prob;			/* the probability of a tuple */
	/* MAYBMS END */
